...
public:
	...
	string getXML(const string &text, string tag);
	...
	string ConcantenateTextXML(string filename, string input, string input2);
	void WriteToFile(string filename, string input);
	void WriteToFileXML(string filename, string input, string input2);
};
